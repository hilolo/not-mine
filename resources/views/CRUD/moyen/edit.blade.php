      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Edit moyen</h3>
          ...
          <!-- /.card-header -->
          <form  method="POST"  action="/editmoyen/{{$files->id}}" enctype="multipart/form-data">
             {{ csrf_field() }}
          <div class="card-body">
          ...
          <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row mx-auto">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control border-primary"  value="{{$files->Matricule}}"  placeholder="Numero matricule " name="Matricule"  userinput6">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row mx-auto last">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control border-primary" value="{{$files->Chauffeur}}"  type="text"  name="Chauffeur" id="userinput7">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mx-auto last">
                                            ...
                                            <div class="col-md-9">
                                               <input class="form-control border-primary" type="text" value="{{$files->Prestataire}}" name="Prestataire"  list="cars"  >
                                               <datalist id="cars">
